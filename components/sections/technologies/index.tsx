    ...
    >
      ...
      <div className="grid gap-12 lg:gap-20">
        ...
        <div className="grid grid-flow-col lg:justify-center lg:gap-24 items-center">
          <Techonology image="/images/html.png" title="HTML" style="w-20 h-20 lg:w-[160px] lg:h-[160px]"/>
          <Techonology image="/images/css.svg.png" title="CSS" style="w-20 h-20 lg:w-[160px] lg:h-[160px]"/>
          <Techonology image="/images/js.png" title="JavaScript" style="w-20 h-20 lg:w-[160px] lg:h-[160px]"/>
          <Techonology image="/images/ts.svg.png" title="TypeScript" style="w-20 h-20 lg:w-[160px] lg:h-[160px]"/>
        </div>
